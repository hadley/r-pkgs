...
Note: If you are on a Windows shell, instead of typing `pwd`, just simply type `cd` to print working directory; and `dir` in lieu of `ls` to list all files in the current directory. 
