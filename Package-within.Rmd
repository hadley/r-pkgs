...
In this book, we achieve this by putting `@export` in the special roxygen comment above each function (namespace management is covered in @sec-metadata-namespace).
...
There are other ways to access functions in another package, explained in @sec-metadata-namespace, but this is our recommended default.
