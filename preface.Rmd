...
-   The very short `inst` chapter has been combined into @sec-misc, with all the other directories that can be important in specific context, but that aren't mission critical to all packages.
