...
-   The chapter on Git/GitHub has been reframed around the topic of software development practices (@sec-sw-dev-practices). This no longer includes step-by-step instructions for basic tasks.
