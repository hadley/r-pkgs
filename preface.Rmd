...
-   Update to reflect changes in the devtools package, specifically, its ["conscious uncoupling"](https://tidyverse.org/blog/2018/10/devtools-2-0-0/#conscious-uncoupling) into a set of smaller, more focused packages.
...
str_glue('
  Thanks to all contributors of the first and second editions (in \\
