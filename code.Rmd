...
The importance of `load_all()` in the testthat workflow is explained in @sec-test-design-tension. Compared to the alternatives, `load_all()` helps you to iterate more quickly and provides an excellent approximation to the namespace regime of an installed package.
