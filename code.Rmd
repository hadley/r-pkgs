...
tidyr_uncount <- tibble(
  ...
  Comments = "Defines exactly one function, `uncount()`, that's not particularly large, but doesn't fit naturally into any other `.R` file"
)
...
-   `usethis::use_tidy_style()` is a wrapper that applies one of the above functions depending on whether the current project is an R package or not.
