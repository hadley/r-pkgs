...
For instance, because R's main object-oriented systems (S3 and S4) are based on generic functions (i.e., methods belong to generic functions not classes), testing approaches built around objects and methods don't make much sense.
