...
For instance, because R's main object-oriented systems (S3 and S4) are based on generic functions (i.e., a method is the implementation of a generic function for an object of a particular class), testing approaches built around objects and methods don't make much sense.
