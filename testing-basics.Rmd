...
The first step in your testing journey is to convince yourself that its benefits are worth the effort.
For some, this is easy to accept.
For others, this must be learned the hard way.

Once you've embraced the virtues of automated testing, you'll need to learn the mechanics and figure out where testing fits into your development workflow.

Be aware that as you and your R packages evolve, you'll to run into situations where you'll need to adopt more test-specific techniques than what what we'll be doing below.
