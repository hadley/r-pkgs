# Designing your test suite {#test-design}
...
Recall the initial testthat setup described in section \@ref(tests-mechanics-workflow): The standard `tests/testhat.R` file looks like this:
