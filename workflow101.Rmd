...
In this case, it may make sense for you to develop your own implementation or to write wrapper functions that hide the sharp edges.
...
If you need to designate the directory of a pre-existing source package as an RStudio Project:
