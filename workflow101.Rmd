...
3.  A basic `NAMESPACE` file, which you'll learn about in @sec-metadata-namespace.
...
We *strongly recommend* that keep the top-level of your source package as the working directory of your R process.
