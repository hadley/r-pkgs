...
`pak::pkg_name_check()` is an alternative function with a similar purpose.
...
-   `NOTE`s: Mild problems or, in a few cases, just an observation.
    ...
    If it's not possible to eliminate a `NOTE`, you'll need to describe why it's OK in your submission comments, as described in @sec-release-process.
