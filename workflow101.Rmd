...
#|   "New Project...", "Open Project...", "Open Project in New Window...", 
#|   a list of projects the user has had open recently, "Close Project", and
#|   "Project Options...". The "Project Options..." item is selected.
...
#| out-width: ~
#| fig-alt: >
#|   Am image of the Project Options preference page in the RStudio IDE. 
#|   On the left side are categories: General, Code Editing, Sweave, 
#|   Build Tools, and Git/SVN.
#|   The General category is selected. In the main part of the window are 
#|   three options: 1. Restore .RData into workspace at startup; 2. Save 
#|   workspace to .RData on exit; and 3. Always save history (even if not 
#|   saving .RData). All three of these options are set to "(Default)". At the 
#|   top of the window is the statement: "Use (Default) to inherit the global 
#|   default setting".
...
*TODO: Decide how to update this diagram and then reposition and re-integrate it with the prose. For example, figure out how to frame w.r.t. RStudio Install and Restart vs. Clean and Rebuild. Do alt-text for new image.*
