...
* `po/`: you can include translations for error messages. This is useful
  but beyond the scope of this book. See the [Internationalization](http://cran.rstudio.com/doc/manuals/r-devel/R-exts.html#Internationalization) chapter of "R extensions" 
  for more details.
