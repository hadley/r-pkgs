...
When you import a package (e.g. ggplot2) and call a function (e.g `ggplot2::ggplot()`), none of the code from that package is included in your package; it's not copied, and therefore copyright, the basis of open source licensing, doesn't come into play.
