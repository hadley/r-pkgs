...
-   **Copyleft** licenses are stricter.
    ...
    Variations of the GPL include the [**LGPL**](https://choosealicense.com/licenses/lgpl-3.0/) which is more permissive and the [**AGPL**](https://choosealicense.com/licenses/agpl-3.0/) which is stricte[^license-1].
