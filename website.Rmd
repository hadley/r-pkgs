...
The advice to use GitHub Actions and Pages are implemented for you in the function `usethis::use_pkgdown_github_pages()`.
...
Keen R user Amelia McNamara [made herself a dress](https://www.amelia.mn/blog/2019-08-17-Tidy-Dress/) out of custom hex logo fabric and useR!
...
We revisit the same hypothetical package as above, but assuming the pkgdown site is in "auto" mode.
