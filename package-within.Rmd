...
In this book, we achieve this by putting `@export` in the special roxygen comment above each function (namespace management is covered in @sec-dependencies-namespace-file).
...
There are other ways to access functions in another package, explained in @sec-dependencies-namespace-file, but this is our recommended default.
