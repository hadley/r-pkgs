...
:::rstudio-tip
An RStudio **Project**, with a capital "P", is a regular directory on your computer that includes some (mostly hidden) RStudio infrastructure to facilitate your work on one more **projects**, with a lowercase "p". A project might be an R package, a data analysis, a Shiny app, a book, a blog, etc.
:::
...
*TODO: Write a matching section on `check()`ing. Maybe goes here but possibly better as first chapter of third part.*