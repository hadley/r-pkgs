...
-   Literally anything written by Kathy Sierra.
    ...
    See her original blog, [Creating passionate users](https://web.archive.org/web/20250913083304/https://headrush.typepad.com/), or the site that came after, [Serious Pony](https://web.archive.org/web/20230411010913/https://seriouspony.com/blog/).
...
If the code can only be run under specific conditions, you must find a way to check for those pre-conditions programmatically at runtime and use the result to set the `eval` option.
