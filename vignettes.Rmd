...
The rendered products (and more) are placed in `inst/doc/`[^vignettes-5] and the `vignettes/` directory disappears.
...
[^vignettes-5]: We highly recommend treating `inst/doc/` as a strictly machine-writable directory for vignettes.
