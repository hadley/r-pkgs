...
confusing, so instead, you can be explicit and refer to `Hmisc::summarise()` or `plyr::summarise()`. Then it doesn't matter the order in which the packages were loaded.
