...
The purpose of the commit message is that when other people (including future you!) are skimming the commits, your commit describes what has changed. It's worthwhile to spend a little effort on your commit messages, so that if you do need to look at history, you can easily see. But don't spend too much time!  Most important when you're on a team.
