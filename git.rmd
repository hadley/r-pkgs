...
1.  If needed, generate a SSH key. SSH keys allow you to securely 
    ...
    If you're using windows, I recommend that you don't use a passphrase. 
    It provides very little additional security, and a considerably amount
    of extra hassle.
...
To ensure your code is clean, I recommend always running `R CMD check` before you push (a topic you'll learn about in chapter on [automated checking](#check)). If you want to publish code that doesn't work (yet), I recommend using a branch, as you'll learn about below in [branching](#git-branch).
