...
1.  Give GitHub your SSH public key: <https://github.com/settings/ssh>.
    The easiest way to find that key is to click "View public key" in the
...
Once Git has been initialised, you'll see two new components:
  ...
  * The __git dropdown__, found in the toolbar, includes Git and GitHub commands
...
The background colours tells you whether the text has been added (green) or removed (red). (If you're colourblind you can use the line numbers in the two columns at the far left. A number in the left column identifies the old version, a number in right column identifies the new version.) The grey lines of code above and below the changes are there to help you to locate where those changes appear in the context of the whole file. 
