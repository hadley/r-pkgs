...
Instead of merging your changes directly back into the main branch, you might want to get some feedback first. A __pull request__ allows to do that. A pull request is a github tool that allows you to review a set of changes. A pull request has three components:
