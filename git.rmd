...
Pushing = publishing your code for the world to use, so you need to make sure it's useful. I think it's good practice to run `R CMD check` before publishing. Fix any problems before pushing.
