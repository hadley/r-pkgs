...
Literally, the `DESCRIPTION` file in the bundled package says `Depends: R (>= 3.5.0)`, even if `DESCRIPTION` in the source package says differently[^description-3].

[^description-3]: The different package states, such as source vs. bundled, are explained in @sec-package-states.
