...
*   Press __Ctrl + .__ then start typing the name:
    ...
    ```{r, echo = FALSE}
    oldbookdown::embed_png("screenshots/file-finder.png", dpi = 220)
    ```

After navigating to a function using one of these tools, you can go back to where you were by clicking the back arrow at the top-left of the editor (`r oldbookdown::embed_png("screenshots/arrows.png", dpi = 240)`), or by pressing Ctrl/Cmd-F9.
...
```{r, echo = FALSE}
oldbookdown::embed_png("screenshots/style-options.png", dpi = 220)
```
