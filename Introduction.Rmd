...
Often the only way we learn how to do it the right way is by doing it the wrong way first. For suffering through many package development errors, we'd like to thank all the CRAN maintainers, especially Brian Ripley, Uwe Ligges and Kurt Hornik. 
...
A special thanks goes to Peter Li, who read the book from cover-to-cover and provided many fixes. We also deeply appreciate the time the reviewers ([Duncan Murdoch](http://www.stats.uwo.ca/faculty/murdoch/), [Karthik Ram](http://karthik.io), [Vitalie Spinu](http://vitalie.spinu.info) and [Ramnath Vaidyanathan](https://ramnathv.github.io)) spent reading the book and giving us thorough feedback.
