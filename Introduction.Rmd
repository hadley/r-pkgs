...
Our recommended approach to devtools and its constituent packages:
  ...
  * For programmatic use, such as inside other packages, developeRs should NOT depend on devtools, but should instead access functions via the package that is their primary home.
