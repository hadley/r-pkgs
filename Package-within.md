...
#> [1] "2021-December-30_07-25-49_swim_clean.csv"
...
```r
outfile_path("INFILE.csv")
#> [1] "2021-December-30_07-25-50_INFILE_clean.csv"

format(Sys.time(), "%Y-%B-%d_%H-%M-%S")
#> [1] "2021-December-30_07-25-51"
```
