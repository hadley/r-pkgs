...
Travis doesn't currently support R as a top-level language, so you'll need to install it. To do so, start with an image designed for testing C projects and download the `travis-tool` script written by [Craig Citro](https://github.com/craigcitro/r-travis). The script downloads a number of useful tools from GitHub:
