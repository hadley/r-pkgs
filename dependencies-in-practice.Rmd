...
Our recommendation is to put a reference (not a call) to an object in aaapkg in some file below `R/`, maybe in a `.R` file associated with package-wide setup:
...
However, note that this causes aaapkg to be loaded whenever your package is loaded.
