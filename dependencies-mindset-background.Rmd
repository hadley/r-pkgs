...
The immediate parent of the global environment is the last package you attached[^dependencies-mindset-background-6], the parent of that package is the second to last package you attached, ...

[^dependencies-mindset-background-6]: Note the difference between attached and loaded.
...
If you follow all the parents back, you see the order in which every package has been attached.
...
In the diagram above, you saw that the parent environment of a package varies based on what other packages have been loaded.
