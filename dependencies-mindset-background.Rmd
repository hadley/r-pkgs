...
-   `Suggests`: your package can use these packages, but doesn't require them.
    ...
    See @sec-dependencies-in-suggests for more about how to check whether a suggested package is installed.
...
One reasonable use of `require()` is in an example that uses a package your package `Suggests`, which is further discussed in @sec-dependencies-suggests-in-examples-and-vignettes.
