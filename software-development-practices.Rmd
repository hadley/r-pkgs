...
In addition to the pre-configured examples featured here, this repository also contains the lower-level building blocks that you could use to build your own custom workflows, such as actions to install R or to install all of the dependencies indicated in a `DESCRIPTION` file.
