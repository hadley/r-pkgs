...
Recent developments in both base R and rlang make it increasingly likely that we can (and should) test the condition's *class*, when we want to be more precise.
...
Test for a condition's class, if you can.
