...
```{r git2r-begin, include = params$debug, eval = FALSE}
library(git2r)
#dir.exists(ff_path)
...
```{r post-git-init-list-files, eval = FALSE}
...
```{r fbind-fodder, asis = TRUE, echo = FALSE, comment = NA, eval = FALSE}
fbind_fodder <- c(
  "fbind <- function(a, b) {",
