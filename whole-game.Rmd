...
```{r fbind-init, echo = params$debug, comment = NA, eval = FALSE}
...
```{r ugly-diff, include = FALSE, eval = FALSE, asis = TRUE, eval = FALSE}
commits(repo)[[1]]
...
```{r check-no-document, eval = FALSE}
...
```{r description-fodder, asis = TRUE, echo = FALSE, comment = NA, eval = FALSE}
...
```{r fbind-roxygen-header, asis = TRUE, echo = FALSE, comment = NA, eval = FALSE}
...
```{r asis = TRUE, echo = FALSE, comment = NA, eval = FALSE}
...
```{r first-check-success, eval = FALSE}
check()
```
