...
Instead, we're mostly going to talk about so-called breaking changes, such as:

-   Removing a function or argument

-   Narrowing the acceptable inputs for a function

In ??,
we explore how to determine whether something is a breaking change or, more realistically, where it lies on a spectrum of "breakingness".
...
The main form of user-facing change is a package release (@sec-lifecycle-evolution) and one of the most overt signals about the nature of change is the version number (@sec-lifecycle-version-number).
