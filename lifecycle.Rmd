...
However, if you just want to quickly check something about a version or [compare two versions of usethis](https://github.com/cran/usethis/compare/1.0.0...1.1.0), the read-only GitHub mirror is much more useful.
