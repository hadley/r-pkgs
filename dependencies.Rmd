...
So far, we've explained the mechanics of declaring a dependency in `DESCRIPTION` (@sec-description-imports-suggests) and how to think about the costs and benefits of dependencies (@sec-dependencies-mindset).
