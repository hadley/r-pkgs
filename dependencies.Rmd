...
Before we describe how to use functions from packages that you Import of Suggest, we need go over the concept of a package namespace and the search path.
