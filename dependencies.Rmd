...
https://github.com/hadley/r-pkgs/issues/486

Importing tidyverse is a bad idea

Use just the bits you need https://github.com/hadley/r-pkgs/issues/609

Main tidyverse thing to address is tidy eval stuff

Caring too much about imports is a bad idea

Having many imports for a low-level package is a bad idea

CRAN's complaint about too many dependencies
