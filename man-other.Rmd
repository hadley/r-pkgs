...
It's also a good place to put the package level import statements that you'll learn about in [imports](#imports).
...
See [documenting multiple objects in one file](#multiple-man) for details.
