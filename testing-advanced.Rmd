...
`skip_if_no_api()` is yet another example of a test helper and the advice already given about where to define it applies here too.
...
test_that("foo api returns an error when given qux", {
  skip_if_no_api()
  ...
})
