...
To get started, make sure you have the latest version of R (at least 3.1.2, which was current when I wrote this book), then run the following code to get the packages you'll need:
