...
Developing packages with devtools may take some time getting used to. However, I strongly believe that the time invested in mastering it will, in the long run, save you much, much more time. Devtools is a key component of my productivity in package development.
