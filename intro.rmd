...
The first ten chapters of the book are arranged according to the structure of an R package. Each chapter describes the files found in one directory. It's roughly organised in order of importance:

* [R code](#r): learn about the most important directory, `R/`, where
  your R code lives. A package with only this directory is still a useful 
  package.
...
* [Vignettes](#vignettes): function documentation describes the nit-picky
  ...
  to create vignettes with a minium of fuss.
...
* [Tests](#tests): to ensure your package works as designed (and continues to
  ...
  correct behaviour, and alert you when functions breaks. In this chapter, I'll
  teach you how to use the testthat packages to convert the informal
  interactive tests that you're already doing to formal, automated tests.

* [Namespace](#namespace): to play nicely with others, your packages needs
...
* [External data](#data): the `data/` directory allows you to include 
  data with your package. You might do this to bundle data (and documented)
...
* [Git and github](#git): mastering a version control system is vital to easily
  colloborate with others, and is useful even for solo work because it allows 
...
This will print out some code which I use to help diagnose problems. If everything is ok, it will returns `TRUE`. Otherwise it will throw an error and you'll need to investigate what the problem is.
