...
```
#> [32m✔[39m Creating [34m'/tmp/Rtmp6ZIOnU/regexcite/'[39m
#> [32m✔[39m Setting active project to [34m'/tmp/Rtmp6ZIOnU/regexcite'[39m
...
#> [90m1[39m 52294f106b190443e706c3d1dd2df519f313708a jennybc <jenny… [90m"[39mInitial…
```
:::
...
<!-- TODO: I can't imagine this chunk_envvar thing does anything. -->
...
```
   checking for file ‘/tmp/Rtmp6ZIOnU/regexcite/DESCRIPTION’ ...
✔  checking for file ‘/tmp/Rtmp6ZIOnU/regexcite/DESCRIPTION’
─  preparing ‘regexcite’:
...
Running /opt/R/4.1.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp6ZIOnU/regexcite_0.0.0.9000.tar.gz --install-tests 
...
<!-- TODO: I mention usethis below. Have I avoided that otherwise here, i.e. always talking about devtools? -->
...
Because this comes up fairly often in real life, usethis has a function, `rename_files()`, to choreograph the renaming of a file in `R/` and its associated companion files below `test/`.
...
#> [36mℹ[39m Building [34m[34m/tmp/Rtmp6ZIOnU/regexcite/README.Rmd[34m[39m
```
