...
```
#> ✔ Creating '/tmp/RtmpKX7l2c/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpKX7l2c/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
#>   <chr>                                    <chr>           <chr>    
#> 1 6cb9ad104c8e6fb76df78d0479303719f382c56d jennybc <jenny… "Initial…
```
...
```
   checking for file ‘/tmp/RtmpKX7l2c/regexcite/DESCRIPTION’ ...
✔  checking for file ‘/tmp/RtmpKX7l2c/regexcite/DESCRIPTION’
─  preparing ‘regexcite’:
...
Running /opt/R/4.1.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKX7l2c/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpKX7l2c/regexcite/README.Rmd'
```
