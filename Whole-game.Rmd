...
```{r fbind-fodder, echo = FALSE, comment = NA, class.output = "sourceCode R"}
fbind_fodder <- c(
  "fbind <- function(a, b) {",
  "  factor(c(as.character(a), as.character(b)))",
  "}"
...
```{r fbind-roxygen-header, echo = FALSE, comment = NA, eval = create, class.output = "sourceCode r"}
...
```{r test-fbind-fodder, echo = FALSE, comment = NA, eval = create, class.output = "sourceCode r"}
test_fodder <- c(
