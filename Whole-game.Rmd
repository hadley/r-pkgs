...
This chapter runs through the development of a small toy package, from beginning to end. It's meant to give you a sense of the Big Picture, before we delve into the details for each of the key components of an R package.
