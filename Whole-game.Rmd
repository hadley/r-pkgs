...
knitr::opts_chunk$set(
  cache = TRUE,
  # Re-run all chunks whenever this file changes
  # TOOD: hash code chunks
  cache.extra = file.mtime("Whole-game.Rmd")
)

# By default, knitr saves loaded packages and reloads in the new session.
# But this doesn't work for foofactors because we want to delete it at the
# end of the chapter
assignInNamespace(
  "cache", ns = "knitr",
