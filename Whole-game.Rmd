...
Load the devtools package. Incidentally, we will also use fs, for filesystem work, and the tidyverse, for data wrangling.

**QUESTION: we need to talk about usethis vs devtools, in general, for the book, for this chapter.**
...
owd
file_copy(
  path(owd, "data", "foofactors-vignette.Rmd"),
  vignette_path,
  overwrite = TRUE
)
```
...
file_copy(
  path(owd, "data", "foofactors-README.Rmd"),
  "README.Rmd",
  overwrite = TRUE
)
```
