...
```{r create-package, eval = create, echo = debug, R.options = list(usethis.description = NULL), class.output = "sourceCode r"}
...
```{r init-show-files, echo = FALSE, eval = create, class.output = "sourceCode r"}
dir_info(all = TRUE) %>% 
  select(path, type)
```
...
```{r inspect-first-commit, echo = FALSE, eval = create, class.output = "sourceCode r"}
git_log(max = 1) %>% 
...
```{r fbind-fodder, asis = TRUE, echo = FALSE, comment = NA, class.output = "sourceCode R"}
fbind_fodder <- c(
  "fbind <- function(a, b) {",
  "  factor(c(as.character(a), as.character(b)))",
  "}"
...
```{r first-check, eval = create, warning = TRUE, echo = FALSE, class.output = "sourceCode r"}
...
```{r license-fodder, asis = TRUE, echo = FALSE, comment = NA, eval = create, class.output = "sourceCode r"}
...
```{r fbind-roxygen-header, asis = TRUE, echo = FALSE, comment = NA, eval = create, class.output = "sourceCode r"}
...
```{r first-clean-check, eval = create, warning = TRUE, echo = FALSE, class.output = "sourceCode r"}
shhh_check(error_on = "never")
```
...
```{r test-fbind-fodder, asis = TRUE, echo = FALSE, comment = NA, eval = create, class.output = "sourceCode r"}
test_fodder <- c(
...
```{r fcount-fodder, echo = FALSE, comment = NA, class.output = "sourceCode r"}
fcount_fodder <- c(
...
```{r final-check, eval = create, warning = TRUE, echo = FALSE, class.output = "sourceCode r"}
shhh_check(error_on = "never")
```
