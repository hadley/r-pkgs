...
#> Error: Expected 10 to be identical to `10 + 1e-07`.
#> Differences:
#>   `actual`: 10.00000000
...
#> Error: Expected 2 to be identical to 2L.
#> Differences:
...
expect_match(string, "testing")
#> Error: Expected `string` to match regexp "testing".
#> Actual text:
#> ✖ │ Testing is fun!
...
#> Error: Expected `model` to inherit from "glm".
#> Actual class: "lm".
----
