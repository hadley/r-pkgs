...
* Update to reflect changes in the devtools package, specifically, its https://tidyverse.org/blog/2018/10/devtools-2-0-0/#conscious-uncoupling["`conscious uncoupling`"] into a set of smaller, more focused packages.
...
#>  roxygen2     * 8.1.0   2026-08-04 [1] RSPM
