...
* Building your package’s website and deploying the rendered site to GitHub Pages, as described in <<sec-website-deployment>>. See also `+?usethis::use_pkgdown_github_pages()+`.
