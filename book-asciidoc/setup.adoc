...
To get started, make sure you have the latest version of R (at least 4.5.2, which is the version being used to render this book), then run the following code to get the packages you’ll need:
