...
#> Error:
#> ! Can't find package `idonotexist` in library locations:
#>   - '/home/runner/work/_temp/Library'
#>   - '/opt/R/4.5.3/lib/R/site-library'
#>   - '/opt/R/4.5.3/lib/R/library'

fs::path_package("extdata", "I_do_not_exist.csv", package = "readr")
#> Error:
#> ! File(s) '/home/runner/work/_temp/Library/readr/extdata/I_do_not_exist.csv' do not exist
