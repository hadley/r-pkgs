...
....
#> ✔ Creating '/tmp/Rtmp0C02wX/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp0C02wX/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8dcb1dcf23… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp0C02wX/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp0C02wX/regexcite_0.0.0.9000.tar.gz --install-tests 
