...
....
#> ✔ Creating '/tmp/RtmpPdiq2x/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpPdiq2x/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|aca94b63b3… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpPdiq2x/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpPdiq2x/regexcite_0.0.0.9000.tar.gz --install-tests 
