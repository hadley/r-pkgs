...
....
#> ✔ Creating '/tmp/RtmpkuU3Ul/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpkuU3Ul/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|d8379db1e5… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpkuU3Ul/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpkuU3Ul/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpkuU3Ul/regexcite/README.Rmd'
----
