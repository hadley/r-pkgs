...
....
#> ✔ Creating '/tmp/Rtmp3TuURF/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp3TuURF/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|4f05bf222b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3TuURF/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3TuURF/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp3TuURF/regexcite/README.Rmd'
----
