...
....
#> ✔ Creating '/tmp/Rtmp5RM1gd/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp5RM1gd/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|c62bbe4d0b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5RM1gd/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5RM1gd/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp5RM1gd/regexcite/README.Rmd'
----
