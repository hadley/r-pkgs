...
....
#> ✔ Creating '/tmp/RtmpoJZmgp/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpoJZmgp/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|45d7191d47… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpoJZmgp/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpoJZmgp/regexcite_0.0.0.9000.tar.gz --install-tests 
