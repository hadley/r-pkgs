...
....
#> ✔ Creating '/tmp/RtmptltMBE/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmptltMBE/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|d0ce873a37… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmptltMBE/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmptltMBE/regexcite_0.0.0.9000.tar.gz --install-tests 
