...
....
#> ✔ Creating '/tmp/RtmpNomg1d/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpNomg1d/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8c5abc9ea5… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpNomg1d/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpNomg1d/regexcite_0.0.0.9000.tar.gz --install-tests 
