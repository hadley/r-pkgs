...
....
#> ✔ Creating '/tmp/RtmpKIXo4s/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpKIXo4s/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|ecd951a80c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpKIXo4s/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKIXo4s/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpKIXo4s/regexcite/README.Rmd'
----
