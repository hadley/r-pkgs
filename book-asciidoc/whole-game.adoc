...
....
#> ✔ Creating '/tmp/RtmpSf6J8g/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpSf6J8g/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5da1697831… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpSf6J8g/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpSf6J8g/regexcite_0.0.0.9000.tar.gz --install-tests 
