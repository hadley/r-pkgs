...
....
#> ✔ Creating '/tmp/RtmpkNTrGC/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpkNTrGC/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|b013e9debc… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpkNTrGC/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpkNTrGC/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpkNTrGC/regexcite/README.Rmd'
----
