...
....
#> ✔ Creating '/tmp/RtmpDcCUei/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpDcCUei/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|26ad463f99… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpDcCUei/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpDcCUei/regexcite_0.0.0.9000.tar.gz --install-tests 
