...
....
#> ✔ Creating '/tmp/RtmpiGZng9/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpiGZng9/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|9c82794396… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpiGZng9/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpiGZng9/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpiGZng9/regexcite/README.Rmd'
----
