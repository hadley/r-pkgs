...
....
#> ✔ Creating '/tmp/RtmpoMP2F4/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpoMP2F4/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpoMP2F4/regexcite'.
...
|6b9abadb5a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpoMP2F4/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpoMP2F4/regexcite_0.0.0.9000.tar.gz --install-tests 
