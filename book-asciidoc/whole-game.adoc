...
....
#> ✔ Creating '/tmp/Rtmp5X1nab/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp5X1nab/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|df19aec64a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5X1nab/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5X1nab/regexcite_0.0.0.9000.tar.gz --install-tests 
