...
....
#> ✔ Creating '/tmp/Rtmp76tPyp/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp76tPyp/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|60a6890382… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp76tPyp/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp76tPyp/regexcite_0.0.0.9000.tar.gz --install-tests 
