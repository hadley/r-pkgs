...
....
#> ✔ Creating '/tmp/RtmpT08qLy/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpT08qLy/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|643596fb7f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpT08qLy/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpT08qLy/regexcite_0.0.0.9000.tar.gz --install-tests 
