...
....
#> ✔ Creating '/tmp/Rtmpv5afUc/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpv5afUc/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|4a6a99734b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpv5afUc/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpv5afUc/regexcite_0.0.0.9000.tar.gz --install-tests 
