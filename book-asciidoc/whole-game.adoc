...
....
#> ✔ Creating '/tmp/RtmpaxhdkF/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpaxhdkF/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|86bfa40820… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpaxhdkF/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpaxhdkF/regexcite_0.0.0.9000.tar.gz --install-tests 
