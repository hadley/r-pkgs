...
....
#> ✔ Creating '/tmp/RtmpZ0o5qg/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpZ0o5qg/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|9ae93e25e6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpZ0o5qg/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpZ0o5qg/regexcite_0.0.0.9000.tar.gz --install-tests 
