...
....
#> ✔ Creating '/tmp/RtmpL2Y4wb/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpL2Y4wb/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|36e964d80e… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpL2Y4wb/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpL2Y4wb/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpL2Y4wb/regexcite/README.Rmd'
----
