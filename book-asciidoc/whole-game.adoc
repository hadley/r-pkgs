...
....
#> ✔ Creating '/tmp/RtmpVD1yxj/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpVD1yxj/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpVD1yxj/regexcite'.
...
|d238a05710… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpVD1yxj/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpVD1yxj/regexcite_0.0.0.9000.tar.gz --install-tests 
