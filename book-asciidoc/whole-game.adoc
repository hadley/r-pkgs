...
....
#> ✔ Creating '/tmp/Rtmpt0AKCf/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpt0AKCf/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|e029bd50e6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpt0AKCf/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpt0AKCf/regexcite_0.0.0.9000.tar.gz --install-tests 
