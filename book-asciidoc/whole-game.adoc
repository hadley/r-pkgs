...
....
#> ✔ Creating '/tmp/RtmpvFILOL/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpvFILOL/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|be8c772409… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpvFILOL/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpvFILOL/regexcite_0.0.0.9000.tar.gz --install-tests 
