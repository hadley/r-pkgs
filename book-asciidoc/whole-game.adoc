...
....
#> ✔ Creating '/tmp/RtmppJe0Qs/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmppJe0Qs/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|57cf970c6d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmppJe0Qs/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmppJe0Qs/regexcite_0.0.0.9000.tar.gz --install-tests 
