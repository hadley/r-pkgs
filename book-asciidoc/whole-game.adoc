...
....
#> ✔ Creating '/tmp/RtmpjkaUOq/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpjkaUOq/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|53711c6ae2… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpjkaUOq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpjkaUOq/regexcite_0.0.0.9000.tar.gz --install-tests 
