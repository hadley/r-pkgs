...
....
#> ✔ Creating '/tmp/Rtmpmbol5w/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpmbol5w/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|d75e8aa107… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpmbol5w/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpmbol5w/regexcite_0.0.0.9000.tar.gz --install-tests 
