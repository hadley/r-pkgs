...
....
#> ✔ Creating '/tmp/Rtmp3yExjB/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp3yExjB/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1012942658… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3yExjB/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3yExjB/regexcite_0.0.0.9000.tar.gz --install-tests 
