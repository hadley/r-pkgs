...
....
#> ✔ Creating '/tmp/RtmpTuXSnq/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpTuXSnq/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|85b089b413… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpTuXSnq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpTuXSnq/regexcite_0.0.0.9000.tar.gz --install-tests 
