...
....
#> ✔ Creating '/tmp/RtmpLqhui3/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpLqhui3/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a38dba4aa2… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpLqhui3/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpLqhui3/regexcite_0.0.0.9000.tar.gz --install-tests 
