...
....
#> ✔ Creating '/tmp/RtmpwwOhuB/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpwwOhuB/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|2f44499fd0… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpwwOhuB/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpwwOhuB/regexcite_0.0.0.9000.tar.gz --install-tests 
