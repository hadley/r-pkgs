...
....
#> ✔ Creating '/tmp/RtmpQlOgb3/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpQlOgb3/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|e7f5d4cafa… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpQlOgb3/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpQlOgb3/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpQlOgb3/regexcite/README.Rmd'
----
