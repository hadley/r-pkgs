...
....
#> ✔ Creating '/tmp/RtmpSyNGyG/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpSyNGyG/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|18f4f51683… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpSyNGyG/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpSyNGyG/regexcite_0.0.0.9000.tar.gz --install-tests 
