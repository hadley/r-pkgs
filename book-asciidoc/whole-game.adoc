...
....
#> ✔ Creating '/tmp/RtmpYXd1FA/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpYXd1FA/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|e857bd121f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpYXd1FA/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpYXd1FA/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpYXd1FA/regexcite/README.Rmd'
----
