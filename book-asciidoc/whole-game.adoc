...
....
#> ✔ Creating '/tmp/RtmpOc9F2s/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpOc9F2s/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|01d5ce422d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpOc9F2s/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpOc9F2s/regexcite_0.0.0.9000.tar.gz --install-tests 
