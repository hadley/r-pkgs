...
....
#> ✔ Creating '/tmp/RtmpL00WQX/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpL00WQX/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|445f65a3c5… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpL00WQX/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpL00WQX/regexcite_0.0.0.9000.tar.gz --install-tests 
