...
....
#> ✔ Creating '/tmp/RtmpeCTw5s/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpeCTw5s/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|188198d806… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpeCTw5s/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpeCTw5s/regexcite_0.0.0.9000.tar.gz --install-tests 
