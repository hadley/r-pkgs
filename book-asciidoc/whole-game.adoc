...
....
#> ✔ Creating '/tmp/RtmpM6sV4p/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpM6sV4p/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|9ecefb29d3… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpM6sV4p/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
── R CMD INSTALL ───────────────────────────────────────────────────
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpM6sV4p/regexcite_0.0.0.9000.tar.gz --install-tests 
...
→ Package library at '/home/runner/work/_temp/Library', '/opt/R/4.6.0/lib/R/site-library', and '/opt/R/4.6.0/lib/R/library'.
