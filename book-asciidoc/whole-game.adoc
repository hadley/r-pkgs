...
....
#> ✔ Creating '/tmp/RtmpBqCTJV/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpBqCTJV/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|ae9dba81fa… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpBqCTJV/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpBqCTJV/regexcite_0.0.0.9000.tar.gz --install-tests 
