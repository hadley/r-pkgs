...
....
#> ✔ Creating '/tmp/RtmpiFdbJr/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpiFdbJr/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpiFdbJr/regexcite'.
...
|c675bb87f3… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpiFdbJr/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpiFdbJr/regexcite_0.0.0.9000.tar.gz --install-tests 
