...
....
#> ✔ Creating '/tmp/RtmpyFob5D/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpyFob5D/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8a5a72ab1a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpyFob5D/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpyFob5D/regexcite_0.0.0.9000.tar.gz --install-tests 
