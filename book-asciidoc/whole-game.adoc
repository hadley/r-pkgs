...
....
#> ✔ Creating '/tmp/RtmpGQWCZj/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpGQWCZj/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a9de42fc65… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpGQWCZj/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpGQWCZj/regexcite_0.0.0.9000.tar.gz --install-tests 
