...
....
#> ✔ Creating '/tmp/RtmpM6q7tC/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpM6q7tC/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|da77e3ee23… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpM6q7tC/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpM6q7tC/regexcite_0.0.0.9000.tar.gz --install-tests 
