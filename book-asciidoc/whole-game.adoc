...
....
#> ✔ Creating '/tmp/RtmpTVNXdS/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpTVNXdS/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a6c61a0077… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpTVNXdS/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpTVNXdS/regexcite_0.0.0.9000.tar.gz --install-tests 
...
Get:9 http://azure.archive.ubuntu.com/ubuntu noble-updates/main amd64 Packages [1227 kB]

Get:10 http://azure.archive.ubuntu.com/ubuntu noble-updates/universe amd64 Packages [1687 kB]

Fetched 3040 kB in 1s (5813 kB/s)
