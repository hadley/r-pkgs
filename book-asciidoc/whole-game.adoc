...
....
#> ✔ Creating '/tmp/RtmphIIskE/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmphIIskE/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7e049715ba… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmphIIskE/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmphIIskE/regexcite_0.0.0.9000.tar.gz --install-tests 
