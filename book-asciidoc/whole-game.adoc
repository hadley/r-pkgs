...
....
#> ✔ Creating '/tmp/Rtmp0Fs5rG/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp0Fs5rG/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|2a311700ad… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp0Fs5rG/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp0Fs5rG/regexcite_0.0.0.9000.tar.gz --install-tests 
