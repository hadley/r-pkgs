...
....
#> ✔ Creating '/tmp/Rtmpbjk7IO/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpbjk7IO/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|6f4b3a07e8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpbjk7IO/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpbjk7IO/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpbjk7IO/regexcite/README.Rmd'
----
