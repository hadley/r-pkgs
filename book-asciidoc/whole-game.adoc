...
....
#> ✔ Creating '/tmp/RtmpWmVYJK/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpWmVYJK/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|fdfdce659e… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpWmVYJK/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpWmVYJK/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpWmVYJK/regexcite/README.Rmd'
----
