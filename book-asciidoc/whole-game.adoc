...
....
#> ✔ Creating '/tmp/Rtmp8fKHrP/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp8fKHrP/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|3dee9b5475… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8fKHrP/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8fKHrP/regexcite_0.0.0.9000.tar.gz --install-tests 
