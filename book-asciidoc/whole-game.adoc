...
....
#> ✔ Creating '/tmp/Rtmp3tQwSf/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp3tQwSf/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1d340e010c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3tQwSf/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3tQwSf/regexcite_0.0.0.9000.tar.gz --install-tests 
