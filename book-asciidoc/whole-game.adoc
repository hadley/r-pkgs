...
....
#> ✔ Creating '/tmp/Rtmpj89Kl5/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpj89Kl5/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5d863e831b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpj89Kl5/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpj89Kl5/regexcite_0.0.0.9000.tar.gz --install-tests 
