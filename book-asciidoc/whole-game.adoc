...
....
#> ✔ Creating '/tmp/RtmpPvJCoL/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpPvJCoL/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|f282fd4f6b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpPvJCoL/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpPvJCoL/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpPvJCoL/regexcite/README.Rmd'
----
