...
....
#> ✔ Creating '/tmp/Rtmpv2NCrl/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpv2NCrl/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|d4d3631937… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpv2NCrl/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpv2NCrl/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpv2NCrl/regexcite/README.Rmd'
----
