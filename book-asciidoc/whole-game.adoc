...
....
#> ✔ Creating '/tmp/RtmpKsGTjT/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpKsGTjT/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|1ebacb2c8d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpKsGTjT/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKsGTjT/regexcite_0.0.0.9000.tar.gz --install-tests 
