...
....
#> ✔ Creating '/tmp/Rtmp9ekvD4/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp9ekvD4/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|990bac41e9… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp9ekvD4/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp9ekvD4/regexcite_0.0.0.9000.tar.gz --install-tests 
