...
....
#> ✔ Creating '/tmp/Rtmp0WxBgX/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp0WxBgX/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a7ba00c11d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp0WxBgX/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp0WxBgX/regexcite_0.0.0.9000.tar.gz --install-tests 
