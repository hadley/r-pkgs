...
....
#> ✔ Creating '/tmp/RtmpmApi05/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpmApi05/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|15a3eefe84… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpmApi05/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpmApi05/regexcite_0.0.0.9000.tar.gz --install-tests 
