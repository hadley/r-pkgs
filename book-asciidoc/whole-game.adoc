...
....
#> ✔ Creating '/tmp/RtmpibQHjE/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpibQHjE/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|688edcfa0f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpibQHjE/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpibQHjE/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpibQHjE/regexcite/README.Rmd'
----
