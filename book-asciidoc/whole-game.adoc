...
....
#> ✔ Creating '/tmp/RtmpRsQ7yq/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpRsQ7yq/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1149a5cd4d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpRsQ7yq/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpRsQ7yq/regexcite_0.0.0.9000.tar.gz --install-tests 
