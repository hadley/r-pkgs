...
....
#> ✔ Creating '/tmp/Rtmp8XRCCg/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp8XRCCg/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|f7f9250caa… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8XRCCg/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8XRCCg/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp8XRCCg/regexcite/README.Rmd'
----
