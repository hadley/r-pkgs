...
....
#> ✔ Creating '/tmp/Rtmpx4l4Nl/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpx4l4Nl/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|d0b09bd384… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpx4l4Nl/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpx4l4Nl/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpx4l4Nl/regexcite/README.Rmd'
----
