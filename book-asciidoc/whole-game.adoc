...
....
#> ✔ Creating '/tmp/RtmpqeBB0a/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpqeBB0a/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|ef0a03026a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpqeBB0a/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpqeBB0a/regexcite_0.0.0.9000.tar.gz --install-tests 
