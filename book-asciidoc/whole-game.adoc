...
....
#> ✔ Creating '/tmp/RtmpCKJe2q/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpCKJe2q/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpCKJe2q/regexcite'.
...
|59abb569ab… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpCKJe2q/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpCKJe2q/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ☐ Use `devtools::build_readme()` to render 'README.Rmd'.
