...
....
#> ✔ Creating '/tmp/Rtmpl9Gqav/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpl9Gqav/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|cfe93f15d5… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpl9Gqav/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpl9Gqav/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpl9Gqav/regexcite/README.Rmd'
----
