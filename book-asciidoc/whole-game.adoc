...
....
#> ✔ Creating '/tmp/RtmpaizdSU/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpaizdSU/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|37d2b8dfba… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpaizdSU/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpaizdSU/regexcite_0.0.0.9000.tar.gz --install-tests 
