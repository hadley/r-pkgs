...
....
#> ✔ Creating '/tmp/Rtmp2Soc15/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp2Soc15/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7fc7f7d75a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp2Soc15/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp2Soc15/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp2Soc15/regexcite/README.Rmd'
----
