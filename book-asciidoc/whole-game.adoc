...
....
#> ✔ Creating '/tmp/RtmpCZiSQ1/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpCZiSQ1/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|0d53761023… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpCZiSQ1/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpCZiSQ1/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpCZiSQ1/regexcite/README.Rmd'
----
