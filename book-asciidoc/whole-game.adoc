...
....
#> ✔ Creating '/tmp/Rtmpr8Z6h1/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpr8Z6h1/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
[width="100%",cols="<21%,<58%,<21%",options="header",]
|===
|commit |author |message
|e413034fde… |hadley hadley@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpr8Z6h1/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpr8Z6h1/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpr8Z6h1/regexcite/README.Rmd'
----
