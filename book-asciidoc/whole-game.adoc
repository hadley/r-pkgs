...
....
#> ✔ Creating '/tmp/Rtmpl8IlS1/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpl8IlS1/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|5bd60edaa6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpl8IlS1/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpl8IlS1/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpl8IlS1/regexcite/README.Rmd'
----
