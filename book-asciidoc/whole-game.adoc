...
....
#> ✔ Creating '/tmp/Rtmpdtcr3X/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpdtcr3X/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|0cbcc35ee0… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpdtcr3X/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpdtcr3X/regexcite_0.0.0.9000.tar.gz --install-tests 
