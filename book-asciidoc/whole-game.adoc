...
....
#> ✔ Creating '/tmp/RtmpgZy77d/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpgZy77d/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|2fde2f71eb… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpgZy77d/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpgZy77d/regexcite_0.0.0.9000.tar.gz --install-tests 
