...
....
#> ✔ Creating '/tmp/RtmpntRb4v/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpntRb4v/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|ee9645b3b9… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpntRb4v/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpntRb4v/regexcite_0.0.0.9000.tar.gz --install-tests 
