...
....
#> ✔ Creating '/tmp/RtmpGGrkSz/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpGGrkSz/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|48de8d3f27… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpGGrkSz/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpGGrkSz/regexcite_0.0.0.9000.tar.gz --install-tests 
