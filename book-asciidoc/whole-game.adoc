...
....
#> ✔ Creating '/tmp/RtmpoKXaFF/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpoKXaFF/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|55b928029d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpoKXaFF/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpoKXaFF/regexcite_0.0.0.9000.tar.gz --install-tests 
