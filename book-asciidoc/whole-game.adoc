...
....
#> ✔ Creating '/tmp/RtmpKk75P1/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpKk75P1/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|47eb261e53… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpKk75P1/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKk75P1/regexcite_0.0.0.9000.tar.gz --install-tests 
