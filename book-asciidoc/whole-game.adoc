...
....
#> ✔ Creating '/tmp/RtmpMXTcfX/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpMXTcfX/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|145e862178… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpMXTcfX/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpMXTcfX/regexcite_0.0.0.9000.tar.gz --install-tests 
