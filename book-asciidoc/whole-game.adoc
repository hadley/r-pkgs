...
....
#> ✔ Creating '/tmp/Rtmpg2oCxC/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpg2oCxC/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|b66dde11ce… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpg2oCxC/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpg2oCxC/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpg2oCxC/regexcite/README.Rmd'
----
