...
....
#> ✔ Creating '/tmp/Rtmp4MbPHO/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp4MbPHO/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|3af6324efe… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp4MbPHO/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp4MbPHO/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp4MbPHO/regexcite/README.Rmd'
----
