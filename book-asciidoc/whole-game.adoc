...
....
#> ✔ Creating '/tmp/RtmpPkOwRu/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpPkOwRu/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpPkOwRu/regexcite'.
...
|11662376d9… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpPkOwRu/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpPkOwRu/regexcite_0.0.0.9000.tar.gz --install-tests 
