...
....
#> ✔ Creating '/tmp/Rtmpnob3vf/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpnob3vf/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|82daa4bbaa… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpnob3vf/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpnob3vf/regexcite_0.0.0.9000.tar.gz --install-tests 
