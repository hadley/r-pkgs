...
....
#> ✔ Creating '/tmp/RtmpFwdjBA/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpFwdjBA/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7b664edfb4… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpFwdjBA/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpFwdjBA/regexcite_0.0.0.9000.tar.gz --install-tests 
