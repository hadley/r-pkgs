...
....
#> ✔ Creating '/tmp/RtmppDL5Td/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmppDL5Td/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|be10adf829… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmppDL5Td/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmppDL5Td/regexcite_0.0.0.9000.tar.gz --install-tests 
