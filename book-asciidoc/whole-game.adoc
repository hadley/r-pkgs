...
....
#> ✔ Creating '/tmp/Rtmpx1lXFl/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpx1lXFl/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|048973c321… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpx1lXFl/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpx1lXFl/regexcite_0.0.0.9000.tar.gz --install-tests 
