...
....
#> ✔ Creating '/tmp/RtmpKKxgf3/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpKKxgf3/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|95b4e176af… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpKKxgf3/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpKKxgf3/regexcite_0.0.0.9000.tar.gz --install-tests 
