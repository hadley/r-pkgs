...
....
#> ✔ Creating '/tmp/Rtmp1JVvex/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp1JVvex/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|64918d71e6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp1JVvex/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp1JVvex/regexcite_0.0.0.9000.tar.gz --install-tests 
