...
....
#> ✔ Creating '/tmp/Rtmp4vfTmK/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp4vfTmK/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|59b78e7c1b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp4vfTmK/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp4vfTmK/regexcite_0.0.0.9000.tar.gz --install-tests 
