...
....
#> ✔ Creating '/tmp/RtmpakPfVg/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpakPfVg/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|8a81e4b2dd… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpakPfVg/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpakPfVg/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpakPfVg/regexcite/README.Rmd'
----
