...
....
#> ✔ Creating '/tmp/RtmpoBvMIJ/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpoBvMIJ/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|dd02373b98… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpoBvMIJ/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.2/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpoBvMIJ/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpoBvMIJ/regexcite/README.Rmd'
----
