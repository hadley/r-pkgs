...
....
#> ✔ Creating '/tmp/RtmpP0NXXN/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpP0NXXN/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1793965a76… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpP0NXXN/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpP0NXXN/regexcite_0.0.0.9000.tar.gz --install-tests 
