...
....
#> ✔ Creating '/tmp/Rtmpc1WAOB/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpc1WAOB/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|6a6e8ee94e… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpc1WAOB/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpc1WAOB/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpc1WAOB/regexcite/README.Rmd'
----
