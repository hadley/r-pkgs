...
....
#> ✔ Creating '/tmp/RtmpTe7dAG/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpTe7dAG/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7e37f81560… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpTe7dAG/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpTe7dAG/regexcite_0.0.0.9000.tar.gz --install-tests 
