...
....
#> ✔ Creating '/tmp/Rtmp5lzGwB/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp5lzGwB/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|728cedba6c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5lzGwB/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5lzGwB/regexcite_0.0.0.9000.tar.gz --install-tests 
