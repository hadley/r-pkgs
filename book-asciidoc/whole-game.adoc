...
....
#> ✔ Creating '/tmp/Rtmpg9MDQL/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpg9MDQL/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|da371534dd… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpg9MDQL/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpg9MDQL/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpg9MDQL/regexcite/README.Rmd'
----
