...
....
#> ✔ Creating '/tmp/RtmpdsQZW1/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpdsQZW1/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|46837f3a2d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpdsQZW1/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpdsQZW1/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpdsQZW1/regexcite/README.Rmd'
----
