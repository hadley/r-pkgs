...
....
#> ✔ Creating '/tmp/RtmpzZAPfR/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpzZAPfR/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1f5d8eb706… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpzZAPfR/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpzZAPfR/regexcite_0.0.0.9000.tar.gz --install-tests 
