...
....
#> ✔ Creating '/tmp/RtmptxaQ28/regexcite/'
#> ✔ Setting active project to '/tmp/RtmptxaQ28/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|9cbf46d0dc… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmptxaQ28/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmptxaQ28/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmptxaQ28/regexcite/README.Rmd'
----
