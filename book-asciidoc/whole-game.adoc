...
....
#> ✔ Creating '/tmp/Rtmp1ZHR1T/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp1ZHR1T/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|fffa6b9cd8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp1ZHR1T/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp1ZHR1T/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp1ZHR1T/regexcite/README.Rmd'
----
