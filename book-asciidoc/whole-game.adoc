...
....
#> ✔ Creating '/tmp/RtmpJTyn42/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpJTyn42/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|14d7917cab… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpJTyn42/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpJTyn42/regexcite_0.0.0.9000.tar.gz --install-tests 
