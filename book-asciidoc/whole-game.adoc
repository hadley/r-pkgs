...
....
#> ✔ Creating '/tmp/Rtmp0X2Ad0/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp0X2Ad0/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|6770769f14… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp0X2Ad0/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp0X2Ad0/regexcite_0.0.0.9000.tar.gz --install-tests 
