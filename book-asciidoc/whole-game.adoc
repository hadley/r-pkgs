...
....
#> ✔ Creating '/tmp/RtmpaPcIKn/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpaPcIKn/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
----
use_git()
#> ✔ Initialising Git repo at '/tmp/RtmpaPcIKn/regexcite'.
...
|e22dd4e641… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpaPcIKn/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpaPcIKn/regexcite_0.0.0.9000.tar.gz --install-tests 
