...
....
#> ✔ Creating '/tmp/Rtmpx3ZRgx/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpx3ZRgx/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|4dba8ba97c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpx3ZRgx/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpx3ZRgx/regexcite_0.0.0.9000.tar.gz --install-tests 
