...
....
#> ✔ Creating '/tmp/RtmpTXOjP7/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpTXOjP7/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|0e4cbca4f0… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpTXOjP7/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpTXOjP7/regexcite_0.0.0.9000.tar.gz --install-tests 
