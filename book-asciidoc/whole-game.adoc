...
....
#> ✔ Creating '/tmp/Rtmp0zQxGM/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp0zQxGM/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5ff27cc551… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp0zQxGM/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp0zQxGM/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp0zQxGM/regexcite/README.Rmd'
----
