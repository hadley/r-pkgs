...
....
#> ✔ Creating '/tmp/Rtmp15pL8N/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp15pL8N/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|54732890e8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp15pL8N/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp15pL8N/regexcite_0.0.0.9000.tar.gz --install-tests 
