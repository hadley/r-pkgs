...
....
#> ✔ Creating '/tmp/Rtmp5Rv1Kn/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp5Rv1Kn/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|b6facd316c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5Rv1Kn/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.4.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5Rv1Kn/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp5Rv1Kn/regexcite/README.Rmd'
----
