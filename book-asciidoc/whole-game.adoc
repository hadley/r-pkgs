...
....
#> ✔ Creating '/tmp/RtmpM2k9by/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpM2k9by/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|77ce202731… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpM2k9by/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpM2k9by/regexcite_0.0.0.9000.tar.gz --install-tests 
