...
....
#> ✔ Creating '/tmp/Rtmp18LcN4/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp18LcN4/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|b93241b761… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp18LcN4/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp18LcN4/regexcite_0.0.0.9000.tar.gz --install-tests 
