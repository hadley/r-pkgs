...
....
#> ✔ Creating '/tmp/Rtmpc0UhDG/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpc0UhDG/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|d286981d47… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpc0UhDG/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpc0UhDG/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpc0UhDG/regexcite/README.Rmd'
----
