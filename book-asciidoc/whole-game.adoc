...
....
#> ✔ Creating '/tmp/Rtmptv9z0s/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmptv9z0s/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8fbbc66e18… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmptv9z0s/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmptv9z0s/regexcite_0.0.0.9000.tar.gz --install-tests 
