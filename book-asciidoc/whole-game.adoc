...
....
#> ✔ Creating '/tmp/RtmpDqE7F0/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpDqE7F0/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8a5a017ff0… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpDqE7F0/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpDqE7F0/regexcite_0.0.0.9000.tar.gz --install-tests 
