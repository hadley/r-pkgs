...
....
#> ✔ Creating '/tmp/Rtmpgfquu4/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpgfquu4/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|d95aae1996… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpgfquu4/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpgfquu4/regexcite_0.0.0.9000.tar.gz --install-tests 
