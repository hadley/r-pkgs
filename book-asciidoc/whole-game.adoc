...
....
#> ✔ Creating '/tmp/RtmprA9UgL/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmprA9UgL/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|56b068f85e… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmprA9UgL/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmprA9UgL/regexcite_0.0.0.9000.tar.gz --install-tests 
