...
....
#> ✔ Creating '/tmp/RtmpcCBmAt/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpcCBmAt/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|518135e64f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpcCBmAt/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpcCBmAt/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> 
#> ! 1 regexcite dependency is out of date.
#>   Update it with `pak::local_install_dev_deps()`.
#>    rlang (behind: 1.2.0 vs 1.3.0)
----
