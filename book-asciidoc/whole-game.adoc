...
....
#> ✔ Creating '/tmp/RtmptRCzgI/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmptRCzgI/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|ddf375dcbd… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmptRCzgI/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmptRCzgI/regexcite_0.0.0.9000.tar.gz --install-tests 
