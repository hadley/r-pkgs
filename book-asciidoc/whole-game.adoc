...
....
#> ✔ Creating '/tmp/Rtmp62IULH/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp62IULH/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|3d3b5e75ff… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp62IULH/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp62IULH/regexcite_0.0.0.9000.tar.gz --install-tests 
