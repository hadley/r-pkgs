...
....
#> ✔ Creating '/tmp/RtmpcPrais/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpcPrais/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|9c9221fbbb… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpcPrais/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpcPrais/regexcite_0.0.0.9000.tar.gz --install-tests 
