...
....
#> ✔ Creating '/tmp/Rtmpf0mK2J/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpf0mK2J/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|56df4ac056… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpf0mK2J/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpf0mK2J/regexcite_0.0.0.9000.tar.gz --install-tests 
