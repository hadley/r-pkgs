...
....
#> ✔ Creating '/tmp/RtmpRTwQJd/regexcite/'
#> ✔ Setting active project to '/tmp/RtmpRTwQJd/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|bea44cba87… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpRTwQJd/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpRTwQJd/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpRTwQJd/regexcite/README.Rmd'
----
