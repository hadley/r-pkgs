...
....
#> ✔ Creating '/tmp/RtmpjQPwdw/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpjQPwdw/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|0b85f28fc6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpjQPwdw/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpjQPwdw/regexcite_0.0.0.9000.tar.gz --install-tests 
