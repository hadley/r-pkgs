...
....
#> ✔ Creating '/tmp/Rtmp8a9Vnn/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp8a9Vnn/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|7820b16dd8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8a9Vnn/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8a9Vnn/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp8a9Vnn/regexcite/README.Rmd'
----
