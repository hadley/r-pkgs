...
....
#> ✔ Creating '/tmp/Rtmppn3m2y/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmppn3m2y/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|05179ad8a3… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmppn3m2y/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmppn3m2y/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmppn3m2y/regexcite/README.Rmd'
----
