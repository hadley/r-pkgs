...
....
#> ✔ Creating '/tmp/Rtmpln5ySW/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpln5ySW/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|c8fb9581c9… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpln5ySW/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpln5ySW/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpln5ySW/regexcite/README.Rmd'
----
