...
....
#> ✔ Creating '/tmp/RtmpDqxhza/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpDqxhza/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|b1b4c67143… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpDqxhza/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpDqxhza/regexcite_0.0.0.9000.tar.gz --install-tests 
