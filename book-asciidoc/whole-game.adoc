...
....
#> ✔ Creating '/tmp/RtmpiyBMjt/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpiyBMjt/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7fdabbecdb… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpiyBMjt/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpiyBMjt/regexcite_0.0.0.9000.tar.gz --install-tests 
