...
....
#> ✔ Creating '/tmp/Rtmp8nf3uT/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp8nf3uT/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|7e9501ba7f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8nf3uT/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8nf3uT/regexcite_0.0.0.9000.tar.gz --install-tests 
