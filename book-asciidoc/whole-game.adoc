...
....
#> ✔ Creating '/tmp/RtmpC8EsSZ/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpC8EsSZ/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|b86fdae19c… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpC8EsSZ/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpC8EsSZ/regexcite_0.0.0.9000.tar.gz --install-tests 
