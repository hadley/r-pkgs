...
....
#> ✔ Creating '/tmp/Rtmp2xwK8p/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp2xwK8p/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a1577c1905… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp2xwK8p/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp2xwK8p/regexcite_0.0.0.9000.tar.gz --install-tests 
