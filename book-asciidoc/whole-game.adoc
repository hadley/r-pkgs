...
....
#> ✔ Creating '/tmp/Rtmpg507kN/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpg507kN/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|056619ef8b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpg507kN/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpg507kN/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpg507kN/regexcite/README.Rmd'
----
