...
....
#> ✔ Creating '/tmp/Rtmp3up5C7/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp3up5C7/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|cc8a6c972b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3up5C7/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.2/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3up5C7/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp3up5C7/regexcite/README.Rmd'
----
