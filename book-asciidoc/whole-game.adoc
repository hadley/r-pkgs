...
....
#> ✔ Creating '/tmp/RtmprE4awo/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmprE4awo/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8b1dbc9aed… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmprE4awo/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmprE4awo/regexcite_0.0.0.9000.tar.gz --install-tests 
