...
....
#> ✔ Creating '/tmp/Rtmp1RMFt9/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp1RMFt9/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|0ebfb81808… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp1RMFt9/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp1RMFt9/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp1RMFt9/regexcite/README.Rmd'
----
