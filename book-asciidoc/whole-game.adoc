...
....
#> ✔ Creating '/tmp/Rtmpg2uzzY/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpg2uzzY/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|d0efbbd5a1… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpg2uzzY/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpg2uzzY/regexcite_0.0.0.9000.tar.gz --install-tests 
