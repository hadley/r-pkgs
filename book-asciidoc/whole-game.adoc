...
....
#> ✔ Creating '/tmp/RtmpwZmbcn/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpwZmbcn/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|73dfd3cce6… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpwZmbcn/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpwZmbcn/regexcite_0.0.0.9000.tar.gz --install-tests 
