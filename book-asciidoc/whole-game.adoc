...
....
#> ✔ Creating '/tmp/RtmptYTCfK/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmptYTCfK/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|8b58c595de… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmptYTCfK/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmptYTCfK/regexcite_0.0.0.9000.tar.gz --install-tests 
