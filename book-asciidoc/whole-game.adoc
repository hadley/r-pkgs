...
....
#> ✔ Creating '/tmp/RtmpAVc44S/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpAVc44S/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|943ea78419… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpAVc44S/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpAVc44S/regexcite_0.0.0.9000.tar.gz --install-tests 
