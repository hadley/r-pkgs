...
....
#> ✔ Creating '/tmp/RtmppBmPoy/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmppBmPoy/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|e4c75fd14d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmppBmPoy/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmppBmPoy/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmppBmPoy/regexcite/README.Rmd'
----
