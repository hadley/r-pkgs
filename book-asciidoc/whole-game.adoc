...
....
#> ✔ Creating '/tmp/RtmpHQXE61/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpHQXE61/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|e7fadb515a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpHQXE61/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpHQXE61/regexcite_0.0.0.9000.tar.gz --install-tests 
