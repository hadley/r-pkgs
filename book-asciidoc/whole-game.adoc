...
....
#> ✔ Creating '/tmp/RtmpweLxuB/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpweLxuB/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5c783b65ac… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpweLxuB/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpweLxuB/regexcite_0.0.0.9000.tar.gz --install-tests 
