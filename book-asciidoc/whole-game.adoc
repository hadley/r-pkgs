...
....
#> ✔ Creating '/tmp/Rtmptzijh4/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmptzijh4/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|9e8dd5f39b… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmptzijh4/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmptzijh4/regexcite_0.0.0.9000.tar.gz --install-tests 
