...
....
#> ✔ Creating '/tmp/Rtmp6H6ZcE/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp6H6ZcE/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|17d839359e… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp6H6ZcE/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp6H6ZcE/regexcite_0.0.0.9000.tar.gz --install-tests 
