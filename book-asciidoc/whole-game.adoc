...
....
#> ✔ Creating '/tmp/Rtmp3BhnWK/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp3BhnWK/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|1361619005… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3BhnWK/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3BhnWK/regexcite_0.0.0.9000.tar.gz --install-tests 
