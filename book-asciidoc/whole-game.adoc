...
....
#> ✔ Creating '/tmp/RtmpNplR2q/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpNplR2q/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|a11b6e4ae4… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpNplR2q/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpNplR2q/regexcite_0.0.0.9000.tar.gz --install-tests 
