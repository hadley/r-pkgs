...
....
#> ✔ Creating '/tmp/RtmpGiyrCw/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpGiyrCw/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|5890bd3024… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpGiyrCw/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpGiyrCw/regexcite_0.0.0.9000.tar.gz --install-tests 
