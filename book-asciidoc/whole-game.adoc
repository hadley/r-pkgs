...
....
#> ✔ Creating '/tmp/Rtmp8qlZAw/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp8qlZAw/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|916492733d… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp8qlZAw/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp8qlZAw/regexcite_0.0.0.9000.tar.gz --install-tests 
