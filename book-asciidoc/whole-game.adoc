...
....
#> ✔ Creating '/tmp/RtmpkLfNcf/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpkLfNcf/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|ac562e216f… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpkLfNcf/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpkLfNcf/regexcite_0.0.0.9000.tar.gz --install-tests 
