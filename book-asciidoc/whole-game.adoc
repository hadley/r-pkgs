...
....
#> ✔ Creating '/tmp/Rtmpxi5Em9/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmpxi5Em9/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|403265a1b8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpxi5Em9/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.1/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpxi5Em9/regexcite_0.0.0.9000.tar.gz --install-tests 
