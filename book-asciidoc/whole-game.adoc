...
....
#> ✔ Creating '/tmp/RtmpDIW2ev/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpDIW2ev/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|f6898b1884… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpDIW2ev/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.5.1/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpDIW2ev/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/RtmpDIW2ev/regexcite/README.Rmd'
----
