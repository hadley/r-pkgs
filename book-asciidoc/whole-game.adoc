...
....
#> ✔ Creating '/tmp/RtmpywwuZI/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmpywwuZI/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|21c2438793… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmpywwuZI/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmpywwuZI/regexcite_0.0.0.9000.tar.gz --install-tests 
