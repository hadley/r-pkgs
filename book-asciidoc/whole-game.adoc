...
....
#> ✔ Creating '/tmp/Rtmp5Ew4ta/regexcite/'.
#> ✔ Setting active project to "/tmp/Rtmp5Ew4ta/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|936c182e5a… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp5Ew4ta/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp5Ew4ta/regexcite_0.0.0.9000.tar.gz --install-tests 
