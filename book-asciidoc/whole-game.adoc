...
....
#> ✔ Creating '/tmp/Rtmp3P80GK/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmp3P80GK/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|7d102ae4e8… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmp3P80GK/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.3/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmp3P80GK/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmp3P80GK/regexcite/README.Rmd'
----
