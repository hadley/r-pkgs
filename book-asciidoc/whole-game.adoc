...
....
#> ✔ Creating '/tmp/Rtmpw9kIui/regexcite/'
#> ✔ Setting active project to '/tmp/Rtmpw9kIui/regexcite'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: regexcite
...
|638d00fd97… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
....
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/Rtmpw9kIui/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.3.0/lib/R/bin/R CMD INSTALL \
  /tmp/Rtmpw9kIui/regexcite_0.0.0.9000.tar.gz --install-tests 
...
#> ℹ Building '/tmp/Rtmpw9kIui/regexcite/README.Rmd'
----
