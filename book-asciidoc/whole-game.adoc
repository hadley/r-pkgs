...
....
#> ✔ Creating '/tmp/RtmptW19yy/regexcite/'.
#> ✔ Setting active project to "/tmp/RtmptW19yy/regexcite".
#> ✔ Creating 'R/'.
#> ✔ Writing 'DESCRIPTION'.
#> Package: regexcite
...
|128f8599d0… |jennybc jennybc@users.noreply.github.com |Initial commit
|===
...
── R CMD build ─────────────────────────────────────────────────────
* checking for file ‘/tmp/RtmptW19yy/regexcite/DESCRIPTION’ ... OK
* preparing ‘regexcite’:
...
Running /opt/R/4.6.0/lib/R/bin/R CMD INSTALL \
  /tmp/RtmptW19yy/regexcite_0.0.0.9000.tar.gz --install-tests 
