...
2. Choose "New Directory":
    ...
    ```{r, echo = FALSE}
    oldbookdown::embed_png("screenshots/create-1.png", dpi = 220)
    ```
   
2. Then "R Package":

    ```{r, echo = FALSE}
    oldbookdown::embed_png("screenshots/create-2.png", dpi = 220)
    ```

2. Then give your package a name and click "Create Project":

    ```{r, echo = FALSE}
    oldbookdown::embed_png("screenshots/create-3.png", dpi = 220)
    ```
...
*   You get useful keyboard shortcuts for common package development tasks.
    ...
    ```{r, echo = FALSE}
    oldbookdown::embed_png("screenshots/keyboard-shortcuts.png")
    ```
...
```{r, echo = FALSE}
oldbookdown::embed_png("screenshots/project-options-1.png", dpi = 220)
oldbookdown::embed_png("screenshots/project-options-2.png", dpi = 220)
```
...
```{r, echo = FALSE}
oldbookdown::embed_png("diagrams/package-files.png")
```
...
```{r, echo = FALSE}
oldbookdown::embed_png("diagrams/installation.png")
```
...
```{r, echo = FALSE}
oldbookdown::embed_png("diagrams/loading.png")
```
