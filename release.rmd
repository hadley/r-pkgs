...
There are good reasons to make backward incompatible changes - if you made a design mistake that makes your package harder to use it's better to fix it sooner rather than later. If you do need to make a backward incompatible, it's best to do it gradually. Provide interim version(s) between where are you now and where you'd like to be, and provide advice about what's going to change. Depending on what you're changing, use one of the following techniques to let your users know what's happening:
...
CRAN is staffed by volunteers, all of whom have other full-time jobs. In a typical week, there are only three volunteers to process 130 packages. The less work you make for them the more likely you are to have a pleasant submission experience.
