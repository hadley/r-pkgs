...
If your package does not pass `R CMD check` or is in violation of one of the CRAN policies, a CRAN maintainer will email you and describe the problems. Failures are frustrating, and the feedback may be curt and may feel downright insulting. Arguing with CRAN maintainers will likely waste both your time and theirs. Instead:
