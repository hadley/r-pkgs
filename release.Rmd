...
These were just the items specific to an initial CRAN release.
The rest of the checklist applies equally to new packages and those that are already on CRAN.
