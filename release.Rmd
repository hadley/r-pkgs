...
You've already learned how to use `R CMD check` and why it's important in @sec-r-cmd-check.
...
-   Eliminate as many `NOTE`s as possible.
    ...
    See @sec-check-checks for details on how to fix individual problems.
