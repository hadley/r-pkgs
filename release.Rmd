...
If your update will break another package (regardless of why), you need to inform the author so they hear it first from you, rather than CRAN.
...
If you decide to do this, make a new checklist in the release issue that lists all the packages that you need to fix.
