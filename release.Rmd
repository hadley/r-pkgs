...
This is meant to be a last-minute, final reminder to double-check that all is well with your package:
...
-   If you can't eliminate a `NOTE`, address it in `cran-comments.md`, exlaining why you think it is spurious.
...
-   GitHub Actions (GHA), as covered in @sec-sw-dev-practices-gha.
