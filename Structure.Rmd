...
> We use the `library()` function to load^[Well, actually, `library()` loads and attaches a package, but that's a topic for another section (\@ref(search-path)).] a __package__. 
