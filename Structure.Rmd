...
If you uncompress a binary package, you'll see that the internal structure is rather different from a source or bundled package. In general, things have now been prepared for use by machines, not humans, and for specific operating systems. Here are a few notable differences:
