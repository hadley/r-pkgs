...
It is possible to use other types of file, but I don't recommend it because `.rdata` files are fast, small and explicit. Other options are described in `data()`.
