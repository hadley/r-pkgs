...
*   Everything works interactively, but the vignette doesn't show up after 
    you've installed the package. This may mean one of the following. First, 
    because that RStudio's "build and reload" doesn't build vignettes, you need 
    to remember to run `devtools::install()` instead. Next check:
