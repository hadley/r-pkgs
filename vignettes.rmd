...
Note that `browseVignettes()` won't show any vignette entries for your package until an install command has been issued. If you want to see how this looks whilst developing your vignette, use `devtools::install(build_vignettes = TRUE)`. 
