...
The draft vignette has been designed to remind you of the important parts of an R Markdown file, so it should be a useful reference when you're creating a new vignette.
