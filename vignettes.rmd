...
Knitr allows you to intermingle code, results and text. Knitr takes R code, runs it, captures the output, and then translates it into formatted Markdown. Knitr captures all printed output, messsages, warnings, errors (optionally) and plots (basic graphics, lattice & ggplot and more). 
...
* `collapse = TRUE` and `comment = "#>"` use my preferred way of displaying
