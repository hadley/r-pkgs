...
Vignettes are long-form pdf guides to your package. There are many types of vignettes, but here I'll only discuss the most useful: Rmarkdown. You can get your package ready to add an vignette by running:
...
1. Add the necessary dependencies to `DESCRIPTION` (i.e. knitr in suggest and 
   vignette builder)
1. Remind you how to create individual vignettes.

You can then write using Rmarkdown and knitr, which are briefly described below.

(If you're familiar with latex and Sweave, you can also write vignettes in latex. However, I've found that since I've switched to Rmarkdown I write vignettes far more often. The restrictions of markdown make it easier to focus on the text. It also doesn't hurt that you don't need the massive latex toolchain to build rmarkdown vignettes.)

## Organisation

You can have as many vignettes as you like. I tend to think of them like chapters of a book - they should be self-contained, but may link together into a cohesive whole.
