...
If you'd like more control over the appearance of your vignette, you'll need to learn more about Rmarkdown. The website, <http://rmarkdown.rstudio.com>, is a great place to start. There can you learn about alternative output formats (like LaTex and pdf) and how you can incorporate raw HTML and LateX if you need additional control.
