...
*Revise this to mostly be a reminder of `load_all()`, then point to earlier coverage in Whole Game and Workflow 101.*

One of the first practical advantages to making your own functions available as a **package** is that it's easy to re-load them, as you refine their functionality or interface.
