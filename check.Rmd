...
If you use GitHub, you'll learn precisely how to do that in @sec-gha.
...
-   **Checking installed package size**.
    ...
    First, make sure the package is as small as it possibly can be: try recompressing the data, @sec-data-cran; and minimising vignettes, @sec-vignettes.
...
-   **Checking package dependencies**.
    ...
    -   Any packages used in the `NAMESPACE` must be listed in one of `Imports` (most commonly) or `Depends` (only in special cases).
        See @sec-search-path for more details.
...
-   **Checking dependencies in R code**.
    ...
    Remember that you should never use `require()` or `library()` inside a package - see @sec-imports for more details on best practices.
