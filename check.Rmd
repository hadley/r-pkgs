...
* __Checking CRAN incoming feasibility__. These checks only apply if you're 
  submitting to CRAN.
    ...
    * The `Title` and `Description` must be free from spelling mistakes. The 
      ...
      should include either the name of your package or the word "package". Also,
      in the `Description` and `Title` section, if you write any other package 
      names, a single quote should be used (e.g., 'tidyverse'). Reword your title 
