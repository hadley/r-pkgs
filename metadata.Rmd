# `DESCRIPTION`, `NAMESPACE`, and `LICENSE` {#sec-metadata}
...
DESCRIPTION, LICENSE, and NAMESPACE are important files and we describe them in this chapter.
...
## The `License` field and related files
