...
DESCRIPTION and NAMESPACE are important files and we describe them in this chapter.

In this chapter we literally describe these files, i.e. if you put X here, it means Y

Subsequent chapters will go more into decision-making (why would do X?) and downstream implications (if you do X, you'll need to know about Z)
...
New section laying out the basics of Imports, Suggests, Depends, LinkingTo, Enhances

There's also SystemRequirements

stuff below here just transplanted!
...
new section that is really short but explains there's a field in DESCRIPTION and possibly other files related to licensing

see the licensing chapter for more
...
-   TO ADD: `VignetteBuilder`, `Language` (?)
