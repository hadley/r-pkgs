...
CRAN prefers that `Authors@R` use a combination of person() rather than as.person().
...
If you specify the license by name, do not also provide a LICENSE file in the source distribution.
...
We'll come back to version numbers in the context of releasing your package, [picking a version number](#release-version). For now, just remember that before releasing, your package version should start at `0.0.0.9000`.
