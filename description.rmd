...
*   `Imports`: packages listed here _must_ be present for your package to 
    ...
    it does _not_ mean that it will be loaded along with your package (i.e., 
...
* [GPL-2](https://tldrlegal.com/license/gnu-general-public-license-v2) or 
  ...
  (derivative works) must also make the source code available. GPL-3 is a little
...
* [CC0](https://tldrlegal.com/license/creative-commons-cc0-1.0-universal). 
  ...
  public domain, a term which is neither well-defined nor meaningful in 
  all countries.
...
* The `Version` number is most important when releasing your package. 
  See [version numbers](#version) for more details.
