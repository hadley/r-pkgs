...
This command says that both the author (aut) and the maintainer (cre) is Hadley Wickham, that his email address is `hadley@rstudio.com`, and that his ORCiD is `0000-0003-4757-117X`. The `person()` function has four main arguments:
...
If you need to add further clarification, you can also use the `comment` argument and supply the desired information in plain text, for example the ORCiD to make you reachable even if your institutional email address changes.
