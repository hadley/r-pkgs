...
It's even possible to use packages to structure your data analyses, as described by Markwick, Boettiger, and Mullen in [@marwick2018-tas] [@marwick2018-peerj].
...
This philosophy is realised primarily through the devtools package, which is the public face for a suite of R functions that automate common development tasks. The release of version 2.0.0 in October 2018 marked its internal restructuring into a set of more focused packages, with devtools becoming more of a meta-package. See below for more details.
...
Version 2.0.0 of devtools is the first major release since Jim Hester assumed the role of devtools' maintainer in February 2018.

TODO: describe the conscious uncoupling (https://www.tidyverse.org/articles/2018/10/devtools-2-0-0/).

TODO: possibly in its own section (?), say what we want people to do re: attaching devtools at startup and calling functions in devtools and usethis. Make sure we have a definitive and linkable statement of the preferred approach.
